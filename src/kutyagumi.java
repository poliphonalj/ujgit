public class kutyagumi {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("a paros szamok osszege: "+sumOfEvens(tomb));
        System.out.println("a paratlan szamok mennyisege: "+evenNumbersInArray(tomb));
    ...
    public static int evenNumbersInArray(int[] tomb){
        int counter=0;
        for (int i = 0; i < tomb.length; i++) {
            if(tomb[i]%2==0){           //feltetelezzuk, hogy a 0 is paros szam:)
                counter++;
            }
        }
        return counter;
